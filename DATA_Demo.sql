...
INSERT INTO `compte` (`TYPE_COMPTE`, `Compte_id`, `dateOuverture`, `solde`, `tauxRemuneration`, `decouvert`, `agence_Agence_id`, `client_id`) VALUES
('EPARGNE', 1, '2017-02-08 00:00:00', 1000, 2.5, NULL, 1, 2),
('COURANT', 2, '2017-02-25 00:00:00', 20000, NULL, 500, 1, 2);
...
INSERT INTO `coordonnees` (`Coordonnees_id`, `adresse`, `cp`, `email`, `telephone`, `ville`) VALUES
(1, '35 rue de la paix', '69000', 'exemple@exemple.com', '0326598746', 'LYON'),
(2, '36 rue de la bienveillance', '75000', 'toto@toto.com', '0356987654', 'PARIS');
...
INSERT INTO `personne` (`TYPE_PERSONNE`, `id`, `login`, `mdp`, `nom`, `prenom`, `entreprise`, `coordonnees_Coordonnees_id`, `conseiller_id`, `AGENCE_ID`, `agence_Agence_id`) VALUES
('CONSEILLER', 1, 'moi', 'moi', 'OUCHARD', 'Laurent', b'0', 1, NULL, 1, 1),
('CLIENT', 2, NULL, NULL, 'LOTMAN', 'Marion', b'0', 2, 1, 0, NULL);
