...
=> créez une nouvelle base appelée bddproxiv3
=> Cliquez sur import
=> Selectionnez le fichier bddproxiv3.sql puis ouvrir
...
NOTE : si vous avez installé les données de démo à l'étape 4, vous pouvez tester le logiciel en vous connectant au compte utilisateur suivant :
Login : moi, Mot de passe : moi
